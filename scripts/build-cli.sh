...
cargo build --release --target x86_64-unknown-linux-musl -p krunc-cli -p krunc-bpf -p krunc-forktest -p krunc-memhog -p krunc-cpuhog
BIN="target/x86_64-unknown-linux-musl/release/krunc"
echo "==> built: $BIN"
ls -l "$BIN"
file "$BIN" 2>/dev/null || true
BPF="target/x86_64-unknown-linux-musl/release/krunc-bpf"
echo "==> built: $BPF"
ls -l "$BPF"
